document.addEventListener("DOMContentLoaded", function(e) {
	...
	document.getElementsByClassName("icon-wrapper keys")[0].addEventListener("click", function() {
		...
		if(keys_wrapper.style.visibility == "visible") {
			...
			if(get_recipient_public_key() !== "[object Object]" && get_recipient_public_key() !== null) {
				...
				keys_wrapper.getElementsByClassName("recipient-public-key")[0].value = "Diğer kullanıcı henüz bağlanmadı.";
			}
	...
	document.getElementsByClassName("icon-wrapper share")[0].addEventListener("click", function() {
		...
		notify("Kopyalandı.", "Bu konuşmanın URL'si panoya kopyalandı. Anonim konuşmak için linki paylaşın.", "theme", 4000);
	});
	...
	document.getElementsByClassName("add-button")[0].addEventListener("click", function() {
		...
		notify("Konuşma Başlatılıyor.", "20 saniyeden fazla sürebilir.", "theme", 4000);
		document.getElementsByClassName("add-button-border")[0].classList.add("animated");
		document.getElementsByClassName("add-button")[0].innerHTML = document.getElementsByClassName("add-button")[0].innerHTML.replace("Konuşma başlat", "Bekleniyor...");
		...
		if(local_storage_available()) {
			if(canvas_available()) {
				...
				if(empty(get_url_query("id"))) {
					...
					document.getElementsByClassName("add-button")[0].innerHTML = document.getElementsByClassName("add-button")[0].innerHTML.replace("Konuşma Başlatın", "Bekleniyor...");
					document.getElementsByClassName("add-button")[0].style.padding = "0 20px 0 30px";
					document.getElementsByClassName("input-field-overlay")[0].style.display = "block";
					join_conversation();
					document.getElementsByTagName("title")[0].textContent = get_code() + " - " + "Anonim X";
					set_remaining_characters();
				}
